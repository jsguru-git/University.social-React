...
export default class SubDetailEvents extends React.Component{
    analysisText(text) {
        let tmpText;
                    ...
                    <Card style={{textAlign:"left"}}>
                        <CardHeader style={{backgroundColor:"white",padding:"0.6rem 1.5rem"}}>
                            <Row  style={{display:"flex",alignItems:"center"}}>
                                <Col xl={1}>
                                    <img src={this.props.detailData.topEvent.imgUrl} alt='media' style={{width:"50px",borderRadius:"30px"}}/>
                                </Col>
                                <Col xl={9}>
                                  <h6 style={{paddingLeft:"1rem",marginBottom:"0"}}>{this.props.detailData.topEvent.author}<small style={commonGrayTextStyle}><br/>{this.props.detailData.topEvent.job}</small></h6>
                                </Col>
                                <Col xl={2}>
                                    <p style={{marginBottom:"0",color:"#888",textAlign:"right"}}>{this.props.detailData.topEvent.postedTime}</p>
                                </Col>
                            </Row>
                        </CardHeader>
                        <CardBody style={{padding:"0"}}>
                            {this.renderMedia(this.props.detailData.topEvent.media)}
                            <div  style={{padding:"1rem"}}>
                                <Row style={{padding:"1rem 0rem"}}>
                                    <Col xl={11} style={{display:"flex",alignItems:"center"}}>
                                      ...
                                      <p style={{color:"#666",margin:"0"}}>{this.props.detailData.topEvent.favorite}</p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                      <FontAwesome className='fa-flip-horizontal' name='comment-o' style={{fontSize:"150%",color:"#888"}}/>&nbsp;&nbsp;&nbsp;
                                      <p style={{color:"#666",margin:"0"}}>{this.props.detailData.topEvent.comments}</p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                ...
                                <small style={commonGrayTextStyle}>{this.props.detailData.topEvent.content}</small>
                                <br/><br/>
                                <a href=""><p style={{color:"#888"}}>View All {this.props.detailData.topEvent.comments} comments</p></a>
                                {this.createTopCommentList(this.props.detailData.topEvent.topComments)}
                                <hr/>
