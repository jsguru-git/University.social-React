...
export default class AdminList extends React.Component{
    ...
    filterUpdated(event){
        ...
        updatedList = updatedList.filter(function(item){
            ...
            event.target.value.toLowerCase()) !== -1) || (item.job.toLowerCase().search(
                ...
                >
                    <Row style={{display:"flex",alignItems:"center"}}>
                        ...
                        <Col xl={8} style={{textOverflow:"ellipsis",whiteSpace:"nowrap",overflow:"hidden"}}>
                            ...
                            <span style={grayTextStyle}>{item.job}</span>
                        </Col>
                        <Col xl={2}>
    ...
    render(){
        return(
            <Card style={{padding:"2rem 1rem",textAlign:"left"}}>
                <h5><b style={{color:"#888"}}>TOTAL ADMINS : <span style={{color:"black"}}>{this.props.data.count}</span></b></h5>
                <br/>
